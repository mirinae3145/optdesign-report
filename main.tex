...
\ifwindows
    \setmainhangulfont[AutoFakeSlant,BoldFont=*,SmallCapsFont=*,BoldSmallCapsFont=*]{Batang}
\fi
\iflinux
    \setmainhangulfont[AutoFakeSlant,BoldFont=*,SmallCapsFont=*,BoldSmallCapsFont=*]{UnBatang}
\fi

\graphicspath{{./figures/}}

\addbibresource{src.bib}
\lstset{language=Matlab,numbers=left,breaklines=True,basicstyle=\footnotesize,upquote=true,showstringspaces=false,morekeywords={clearvars,struct,deal,optimoptions,fmincon,box,contourf,xlim,ylim},gobble=24}
